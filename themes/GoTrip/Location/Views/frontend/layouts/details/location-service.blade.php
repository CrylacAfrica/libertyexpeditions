                    ...
                    <div class="col-auto">
                        <div class="sectionTitle -md">
                            ...
                            <p class=" sectionTitle__text mt-5 sm:mt-0">
                                @if($moduleName === 'tour')
                                    {{ __("Explore breathtaking destinations and unforgettable experiences.") }}
                                @elseif($moduleName === 'space')
                                    {{ __("Discover your perfect home away from home.") }}
                                @elseif($moduleName === 'hotel')
                                    {{ __("Relax in top-rated hotels tailored to your comfort.") }}
                                @else
                                    {{ __("Enjoy unparalled luxury and convenience") }}
                                @endif
                            </p>
                        </div>
                    </div>
