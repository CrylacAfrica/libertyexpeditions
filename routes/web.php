...
Route::get('/fix-tour-slugs-secret-123', function() {
    $tours = \Modules\Tour\Models\Tour::all();
    ...
    foreach($tours as $tour) {
        ...
        // Handle duplicates
        while(\Modules\Tour\Models\Tour::where('slug', $slug)->where('id', '!=', $tour->id)->exists()) {
    ...
    return 'Updated ' . $tours->count() . ' tour slugs!';
});
