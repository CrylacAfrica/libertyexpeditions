    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <?php do_action(\Modules\Tour\Hook::TOUR_SETTING_AFTER_LAYOUT_SEARCH) ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="tab-content" >
                        ...
                        <?php
                            $seo_share = json_decode(setting_item_with_lang('tour_page_list_seo_share',request()->query('lang'),'[]'),true);
                        ?>
...
<?php endif; ?>
<?php /**PATH /home/libertye/public_html/modules/Tour/Views/admin/settings/tour.blade.php ENDPATH**/ ?>