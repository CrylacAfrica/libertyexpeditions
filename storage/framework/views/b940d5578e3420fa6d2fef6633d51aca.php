...
<div class="location_banner">
    ...
    <div class="relative d-flex">
        ...
        <div class="absolute z-2 px-50 py-60 text-banner">
            ...
            <?php if(!in_array(strtolower($translation->name), [
                'detox and wellness',
                ...
                <div class="text-white">
                    <?php echo e(__("Explore deals, travel guides and things to do in :text", ['text' => $translation->name])); ?>
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Location/Views/frontend/layouts/details/location-banner.blade.php ENDPATH**/ ?>