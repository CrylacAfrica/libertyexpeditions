    ...
    <section class="layout-pt-lg layout-pb-lg">
        <div class="container">
            <div class="row justify-between items-end">
                ...
                <div class="col-auto">
                    <a href="<?php echo e(route('event.search', ['location_id' => $row->location_id])); ?>" class="button h-50 px-24 -blue-1 bg-blue-1-05 text-blue-1">
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Event/Views/frontend/layouts/details/related.blade.php ENDPATH**/ ?>