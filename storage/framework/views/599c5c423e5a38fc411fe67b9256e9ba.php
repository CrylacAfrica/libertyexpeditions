...
<?php if(!empty($types)): ?>
                    ...
                    <div class="col-auto">
                        <div class="sectionTitle -md">
                            <h2 class="sectionTitle__title"><?php echo e(__('Most Popular :name',['name'=> call_user_func([$moduleClass,'getModelName']) ])); ?></h2>
                                <?php
                                    $moduleName = strtolower(call_user_func([$moduleClass, 'getModelName']));
                                ?>
                            <p class=" sectionTitle__text mt-5 sm:mt-0">
                                <?php if($moduleName === 'tour'): ?>
                                    <?php echo e(__("Explore breathtaking destinations and unforgettable experiences.")); ?>

                                <?php elseif($moduleName === 'space'): ?>
                                    <?php echo e(__("Discover your perfect home away from home.")); ?>

                                <?php elseif($moduleName === 'hotel'): ?>
                                    <?php echo e(__("Relax in top-rated hotels tailored to your comfort.")); ?>

                                <?php else: ?>
                                    <?php echo e(__("Enjoy unparalled luxury and convenience")); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Location/Views/frontend/layouts/details/location-service.blade.php ENDPATH**/ ?>