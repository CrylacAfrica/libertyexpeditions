...
<?php $__env->stopPush(); ?>
<div class="container">
    <div class="bravo-vendor-form-register layout-pt-lg <?php if(!empty($layout)): ?> <?php echo e($layout); ?> <?php endif; ?>">
        <div class="row">
            <div class="col-12 col-lg-5">
                <h1 class="mb-10"><?php echo e($title); ?></h1>
                <p class="sub-heading mb-30"><?php echo e($desc); ?></p>
                <form class="form bravo-form-register-vendor" method="post" action="<?php echo e(route('vendor.register')); ?>">
                    <?php echo csrf_field(); ?>

                    <div class="form-group">
                        <input type="text" class="form-control border" name="first_name" autocomplete="off" placeholder="<?php echo e(__("First Name")); ?>">
                    ...
                    <div class="form-group mt-15">
                        <button type="submit" class="button -md -blue-1 bg-dark-3 text-white form-submit">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Vendor/Views/frontend/blocks/form-register/index.blade.php ENDPATH**/ ?>