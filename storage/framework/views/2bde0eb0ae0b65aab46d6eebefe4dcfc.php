                ...
                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($layout == 'grid'): ?>
                        <div class="col-lg-4 col-sm-6">
                            <?php echo $__env->make('Hotel::frontend.layouts.search.loop-grid-2',['wrap_class'=>'item-loop-wrap'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    <?php else: ?>
                        <div class="col-12">
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Hotel/Views/frontend/ajax/search-result-map.blade.php ENDPATH**/ ?>