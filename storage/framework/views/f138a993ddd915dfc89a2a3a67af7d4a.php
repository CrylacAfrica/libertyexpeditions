    ...
    <?php $__currentLoopData = $passengers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$passenger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card">
            <div class="card-header c-pointer" id="passenger_heading_<?php echo e($i + 1); ?>">
                <h4 class="mb-0 " style="font-size: 16px" data-toggle="collapse" data-target="#passenger_<?php echo e($i + 1); ?>" data-bs-toggle="collapse" data-bs-target="#passenger_<?php echo e($i + 1); ?>" aria-expanded="true"
...
<?php /**PATH /home/libertye/public_html/themes/Base/Booking/Views/frontend/detail/passengers.blade.php ENDPATH**/ ?>