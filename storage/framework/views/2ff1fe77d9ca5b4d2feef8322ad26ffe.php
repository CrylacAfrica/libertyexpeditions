...
<?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-auto">
                            <label  class="cursor-pointer">
                                <div class="form-checkbox d-flex items-center">
                                    <input <?php if(in_array($term->id,$selected[$item->slug] ?? [])): ?> checked <?php endif; ?> type="checkbox" name="attrs[<?php echo e($item->slug); ?>][]" value="<?php echo e($term->slug); ?>">
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Layout/global/search/filters/attrs.blade.php ENDPATH**/ ?>