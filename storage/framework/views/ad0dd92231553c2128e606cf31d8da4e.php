    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
                                    ...
                                    <?php if($booking->status !='draft'): ?>
                                        ...
                                        <?php if($booking->paid < $booking->total ): ?>
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="val d-flex align-items-center"><?php echo e(currency_symbol()); ?><input class="text-right form-control ml-1" type="number" min="0" max="<?php echo e($booking->total); ?>" id="set_paid_input" value="<?php echo e(($booking->total - $booking->paid)); ?>" />
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    <?php endif; ?>
            ...
            <div class="modal-footer">
                ...
                <span class="btn btn-secondary" data-bs-dismiss="modal" data-dismiss="modal"><?php echo e(__("Close")); ?></span>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/libertye/public_html/themes/Base/Tour/Views/frontend/booking/set-paid-modal.blade.php ENDPATH**/ ?>