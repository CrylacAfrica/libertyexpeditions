        ...
        <div class="container">
            <div class="row y-gap-40 justify-center text-center">
                ...
                <div class="col-12">
                    ...
                    <?php elseif($image_url = get_file_url($row->image_id, 'full')): ?>
                        ...
                        <div class="border-top-light border-bottom-light py-30 mt-30">
                            <div class="row y-gap-30">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="text-15 mt-10"><?php echo $row->author->bio; ?></div>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/libertye/public_html/themes/GoTrip/News/Views/frontend/detail.blade.php ENDPATH**/ ?>