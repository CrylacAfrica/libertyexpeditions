    ...
    <div class="relative d-flex justify-center js-section-slider" data-gap="10" data-slider-cols="xl-2 lg-2 base-1" data-nav-prev="js-img-prev" data-nav-next="js-img-next" data-loop>
            ...
            <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="swiper-slide">
                    <div class="ratio ratio-64:45">
                        <img src="<?php echo e($item['thumb']); ?>" alt="<?php echo e(__("Gallery")); ?>" class="rounded-4 img-ratio">
                    </div>
                </div>
        ...
        <div class="absolute h-full col-12 px-20 py-20 d-flex justify-end items-end gotrip-banner">
            ...
            <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($key == 0): ?>
                    <a href="<?php echo e($item['large']); ?>" class="button -blue-1 px-24 py-15 bg-white text-dark-1 z-2 js-gallery" data-gallery="gallery2">
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Layout/common/detail/gallery4.blade.php ENDPATH**/ ?>