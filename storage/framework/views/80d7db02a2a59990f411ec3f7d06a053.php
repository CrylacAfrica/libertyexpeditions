                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center">
                                <h1 class="text-30 fw-600"><?php echo e(setting_item_with_lang("space_page_search_title")); ?></h1>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <?php echo $__env->make('Space::frontend.layouts.search.list-item', ['layout' => $layout], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/libertye/public_html/themes/GoTrip/Space/Views/frontend/search.blade.php ENDPATH**/ ?>