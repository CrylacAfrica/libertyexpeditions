        ...
        <div class="halfMap__content">
            <div class="bravo_form_search_map">
                <div class="mainSearch bg-white pr-10 py-10 lg:px-20 lg:pt-5 lg:pb-20 bg-light-2 rounded-4">
                    <?php echo $__env->make('Space::frontend.layouts.search.form-search', ['style' => 'map'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <div class="bravo_filter_search_map" id="advance_filters">
                <?php echo $__env->make('Space::frontend.layouts.search-map.filter-search-map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            ...
            <div class="row y-gap-10 justify-between items-center pt-20">
                ...
                <div class="col-auto bc-form-order">
                    <?php echo $__env->make('Layout::global.search.orderby',['routeName'=>'boat.search','hidden_map_button'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <div class="ajax-search-result">
                <?php echo $__env->make('Space::frontend.ajax.search-result-map', ["layout" => "normal"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app',['container_class'=>'container-fluid','header_right_menu'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/libertye/public_html/themes/GoTrip/Space/Views/frontend/search-map.blade.php ENDPATH**/ ?>