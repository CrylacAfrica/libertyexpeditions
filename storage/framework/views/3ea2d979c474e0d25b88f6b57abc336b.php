        ...
        <?php if(!empty($group['name'])): ?>
            <li class="group mt-3 pos-<?php echo e($group['position'] ?? 0); ?>">
                <span class="group-name  d-flex align-items-center justify-content-between "><?php echo e($group['name']); ?>
                    ...
                    <?php if($require_pro): ?>
                        <a href="#" <?php if(!isPro()): ?> data-toggle="modal" data-target="#upgrade-pro" <?php else: ?> title="Pro feature" <?php endif; ?> class="">
...
<?php /**PATH /home/libertye/public_html/modules/Layout/admin/parts/sidebar.blade.php ENDPATH**/ ?>