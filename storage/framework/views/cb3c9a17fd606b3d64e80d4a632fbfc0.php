...
<?php else: ?>
    <div class="searchMenu-loc js-form-dd js-liverSearch item">
        ...
        <div class="searchMenu-loc__field shadow-2 js-popup-window <?php if( $type == "autocomplete"): ?> d-none <?php endif; ?>" data-x-dd="searchMenu-loc" data-x-dd-toggle="-is-active">
...
<?php endif; ?>
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Layout/common/search/fields/location.blade.php ENDPATH**/ ?>