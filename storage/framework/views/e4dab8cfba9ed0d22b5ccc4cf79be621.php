...
<?php $__env->startSection('content'); ?>
    <div id="live-editor" class=" flex-column overflow-auto" v-cloak="">
        <div class="live-topbar flex-shrink-0 d-flex justify-content-between py-3 px-3 ">
            ...
            <div>
                <?php echo $__env->make('Template::admin.live.parts.lang_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div>
                <span
...
<?php echo $__env->make('Layout::admin.empty', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/libertye/public_html/modules/Template/Views/admin/live/index.blade.php ENDPATH**/ ?>