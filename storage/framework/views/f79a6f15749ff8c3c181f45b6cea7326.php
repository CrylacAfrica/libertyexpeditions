    ...
    <div class="col-md">
        <div class="d-flex flex-column h-full justify-between">
            <div class="has-skeleton">
                ...
                <?php endif; ?>
                <h3 class="text-18 lh-16 fw-500"><a <?php if(!empty($blank)): ?> target="_blank" <?php endif; ?> href="<?php echo e($row->getDetailUrl()); ?>"><?php echo e($translation->title); ?></a></h3>
            </div>
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Space/Views/frontend/layouts/search/loop-item.blade.php ENDPATH**/ ?>