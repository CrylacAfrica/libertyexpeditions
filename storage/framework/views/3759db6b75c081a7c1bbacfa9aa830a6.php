        ...
        <div class="row y-gap-30">
            <div class="col-xl-12">
                <div class="row y-gap-40">
                    ...
                    <?php endif; ?>
                    <?php if ($__env->exists("Layout::common.detail.surrounding")) echo $__env->make("Layout::common.detail.surrounding", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Hotel/Views/frontend/layouts/details/hotel-detail.blade.php ENDPATH**/ ?>