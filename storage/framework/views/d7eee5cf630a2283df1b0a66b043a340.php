        ...
        <div class="halfMap__content">
            ...
            <div class="row y-gap-10 justify-between items-center pt-20">
                ...
                <div class="col-auto bc-form-order">
                    <?php echo $__env->make('Layout::global.search.orderby',['routeName'=>'hotel.search','hidden_map_button'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <div class="ajax-search-result">
                <?php echo $__env->make('Hotel::frontend.ajax.search-result-map', ["layout" => "normal"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/libertye/public_html/themes/GoTrip/Hotel/Views/frontend/search-map.blade.php ENDPATH**/ ?>