        ...
        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($layout == 'grid'): ?>
                <div class="col-lg-4 col-sm-6">
                    <?php echo $__env->make('Car::frontend.layouts.search.loop-grid',['wrap_class'=>'item-loop-wrap inner-loop-wrap'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            <?php else: ?>
                <div class="col-12">
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Car/Views/frontend/ajax/search-result.blade.php ENDPATH**/ ?>