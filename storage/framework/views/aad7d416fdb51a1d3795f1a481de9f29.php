...
<form action="<?php echo e(route("boat.search")); ?>" class="gotrip_form_search bravo_form bravo_form_search form-search-all-service form <?php echo e($classes); ?>" method="get">
    <?php if( !empty(Request::query('_layout')) ): ?>
        <input type="hidden" name="_layout" value="<?php echo e(Request::query('_layout')); ?>">
    <?php endif; ?>
    <?php $search_style = setting_item('boat_location_search_style','normal');
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Boat/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>