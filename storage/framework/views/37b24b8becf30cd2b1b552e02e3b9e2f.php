...
<?php if($reviews->total()): ?>
    <div class="bravo-reviews">
        ...
        <div class="text-center mt-30"><a class="button h-50 px-24 -dark-1 bg-blue-1 text-white d-inline-flex" href="<?php echo e(route('user.profile.reviews',['id'=> $user->user_name ?? $user->id])); ?>"><?php echo e(__('View all reviews (:total)',['total'=>$reviews->total()])); ?></a></div>
    </div>
<?php endif; ?>
<?php /**PATH /home/libertye/public_html/themes/GoTrip/User/Views/frontend/profile/reviews.blade.php ENDPATH**/ ?>