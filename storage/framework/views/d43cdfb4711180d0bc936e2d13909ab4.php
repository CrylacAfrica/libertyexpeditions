...
<div class="row">
    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <?php if(is_default_lang()): ?>
            <div class="panel-body">
                <select name="cookie_agreement_type" class="form-control mb-3">
                    <option
                        value="" <?php echo e(setting_item('cookie_agreement_type') == '' ? 'selected' : ''); ?>><?php echo e(__('-- Select one --')); ?></option>
                    <option
                        value="cookie_consent" <?php echo e(setting_item('cookie_agreement_type') == 'cookie_consent' ? 'selected' : ''); ?>><?php echo e(__('Style 1')); ?></option>
                    <option
                        value="cookie_agreement" <?php echo e(setting_item('cookie_agreement_type') == 'cookie_agreement' ? 'selected' : ''); ?>><?php echo e(__("Style 2")); ?></option>
                </select>
                <div data-condition="cookie_agreement_type:is(cookie_agreement)">
                    <hr>
                    <div class="form-group">
                        <label><?php echo e(__("Agree Text Button")); ?></label>
                        <div class="form-controls">
                            <input type="text" name="cookie_agreement_button_text"
                                   value="<?php echo e(setting_item_with_lang('cookie_agreement_button_text',request()->query('lang')) ?? ''); ?>"
                                   class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <textarea name="cookie_agreement_content" rows="8"
                                      class="form-control d-none has-ckeditor"><?php echo e(setting_item_with_lang('cookie_agreement_content',request()->query('lang')) ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/libertye/public_html/modules/Core/Views/admin/settings/groups/advance.blade.php ENDPATH**/ ?>