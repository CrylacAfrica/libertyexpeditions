<div class="profile-summary mb-2">
    <div class="profile-avatar">
        <?php if($avatar = $user->getAvatarUrl()): ?>
            <div class="avatar-img avatar-cover" style="background-image: url('<?php echo e($user->getAvatarUrl()); ?>');background-size: cover">
            </div>
        <?php else: ?>
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/User/Views/frontend/profile/sidebar.blade.php ENDPATH**/ ?>