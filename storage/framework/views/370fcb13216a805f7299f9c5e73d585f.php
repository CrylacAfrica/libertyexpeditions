    ...
    <div class="service-nav-tabs mb-20">
        <ul class="nav nav-tabs">
            ...
            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type=>$moduleClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                    <li class="nav-item">
                        <a href="#" class="nav-link <?php if(!$i): ?> active <?php endif; ?>" data-bs-toggle="tab" data-bs-target="#type_<?php echo e($type); ?>"><?php echo e($moduleClass::getModelName()); ?></a>
                    </li>
                <?php $i++; ?>
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/User/Views/frontend/profile/services.blade.php ENDPATH**/ ?>