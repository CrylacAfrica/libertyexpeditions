...
<div class="bravo_single_book_wrap d-flex justify-end js-pin-content <?php if(setting_item('event_enable_inbox')): ?> has-vendor-box <?php endif; ?>" data-offset="120">
                            ...
                            <div class="col-12" v-for="(type,index) in ticket_types" v-if="ticket_types">
                                <div class="searchMenu-guests px-20 py-10 border-light rounded-4 js-form-dd" :class="{'d-none':type.max==0}">
                                    <div data-x-dd-click="searchMenu-guests">
                                        ...
                                        <h4 class="text-12 fw-400 ls-2 text-light-1">{{type.display_price}} <?php echo e(__("per ticket")); ?></h4>
...
<?php /**PATH /home/libertye/public_html/themes/GoTrip/Event/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>